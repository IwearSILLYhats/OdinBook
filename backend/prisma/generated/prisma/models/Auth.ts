...
export type AuthWhereInput = {
  ...
  provider?: Prisma.EnumproviderFilter<"Auth"> | $Enums.provider
...
export type AuthScalarWhereWithAggregatesInput = {
  ...
  provider?: Prisma.EnumproviderWithAggregatesFilter<"Auth"> | $Enums.provider
...
export type AuthOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "user_id" | "provider" | "provider_id" | "password", ExtArgs["result"]["auth"]>
...
export interface AuthFieldRefs {
  ...
  readonly provider: Prisma.FieldRef<"Auth", 'provider'>
